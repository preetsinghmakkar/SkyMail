...
export function Navbar() {
  ...
  return (
    <nav
      className={cn(
        "fixed top-0 left-0 right-0 z-50 mx-auto px-4 sm:px-6 lg:px-8 transition-all duration-300",
        scrolled ? "py-2.5 m-3" : "py-4 m-4",
        scrolled
        ...
        "border border-black/5 dark:border-white/10 rounded-2xl sm:rounded-full max-w-5xl ml-auto mr-auto"
      )}
    >
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="md:hidden ml-auto p-2 hover:bg-gray-100 dark:hover:bg-white/10 rounded-lg transition-colors"
        >
          {isOpen ? (
