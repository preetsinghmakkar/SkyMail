...
export function TemplateEditorV2({
  ...
  useEffect(() => {
    ...
    allVariables.forEach((variable) => {
      // If preview data doesn't have this variable, generate sample value
  ...
  const mutation = useMutation({
    mutationFn: async () => {
      ...
      // Validate that subject and HTML contain {{variable}} patterns if we expect variables
      ...
      // Store extracted variables (NOT preview data, NOT manual input)
    ...
    onError: (error: any) => {
      setErrorMessage(
        error.message || error.response?.data?.detail || "Failed to save template"
      );
      setSuccessMessage("");
    },
  });
        ...
        <div>
          ...
          <p className="text-gray-600 text-sm mt-1">
            {templateId
              ...
              : "Design your newsletter template with {{variable}} placeholders"}
          </p>
        </div>
        <button
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-6 space-y-4">
            ...
            <p className="text-sm text-gray-600">
              This is how the email will look when sent (with variable values
              replaced).
            </p>
          ...
          {allVariables.length > 0 && (
            <div className="bg-green-50 border border-green-200 rounded-lg p-6">
              ...
              <p className="text-sm text-gray-600 mb-4">
                These variables were automatically found in your template. They
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-6 space-y-4">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 mt-2">
                Use {`{{variable_name}}`} syntax for placeholders. Variables will
                be auto-extracted.
              </p>
            </div>
